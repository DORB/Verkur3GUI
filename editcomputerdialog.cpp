...
void EditComputerDialog::on_input_add_computers_year_textChanged(const QString &arg1)
{
...
void EditComputerDialog::on_input_add_computers_name_textChanged(const QString &arg1)
{
    if(arg1 != "")
        name_valid = true;
    else
...
void EditComputerDialog::on_input_add_computers_type_textChanged(const QString &arg1)
{
    if(arg1 != "")
        type_valid = true;
    else
